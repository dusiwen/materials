...
@endsection
<div class="modal fade" id="modalFactoryReturn">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">返厂入所</h4>
            </div>
            <div class="modal-body form-horizontal">
                <form id="frmStoreFactoryReturn" style="font-size: 18px;">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-flat btn-lg" onclick="fnStoreFactoryReturn()"><i class="fa fa-check">&nbsp;</i>确定</button>
            </div>
        </div>
    </div>
</div>
