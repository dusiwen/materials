        ...
        <div class="box box-warning">
            ...
            <form class="form-horizontal" id="frmUpdate">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 col-md-8">
                        <input placeholder="唯一标识" disabled class="disabled form-control input-lg" type="text" required onkeydown="if(event.keyCode==13){return false;}"
                               name="unique_code" value="{{$category->unique_code}}">
                    </div>
                </div>
                <div class="box-footer">
                    <a href="{{url('category')}}?page={{request()->get('page',1)}}" class="btn btn-default pull-left btn-flat btn-lg"><i class="fa fa-arrow-left">&nbsp;</i>返回</a>
        ...
        fnUpdate = function () {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    alert(response);
                    location.href="{{url('category')}}?page{{request()->get('page',1)}}";
                },
